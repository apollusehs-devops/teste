...
import com.skaffolder_teste.db.teste_db.dtos.UserDto;
import com.skaffolder_teste.db.teste_db.entity.Roles;

//IMPORT RELATIONS

import com.skaffolder_teste.db.teste_db.service.ClienteService;

import com.skaffolder_teste.db.teste_db.service.RolesService;
...
//CRUD METHODS
	...
	public ResponseEntity<UserDto> insert(@RequestBody User obj) {
		...
		//external relation cliente
		if (obj.getCliente() != null && !obj.getCliente().isEmpty())
			obj.getCliente().forEach(cliente -> clienteService.insert(cliente));
	...
	public ResponseEntity<Void> delete(@PathVariable("id") Long id) {
		...
		//external relation cliente
		if (userSelected.getCliente() != null && !userSelected.getCliente().isEmpty()) {
			userSelected.getCliente().forEach(cliente -> clienteService.delete(cliente.get_id()));
		}
